                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <select class="form-control" name="category" id="category" data-toggle="select2">
                                            ...
                                            if($category->num_rows() > 0)
                                            {
                                                ...
                                                {
                                                    $selected = isset($_REQUEST['category']) && $_REQUEST['category'] != '' && $_REQUEST['category'] == $c['category'] ? 'selected' : '';
...
<script type="text/javascript">
    $('#clear_filter').click(function(){
        ...
        window.location.href = '<?php echo base_url();?>reports';
    });
    ...
    function export_csv()
    {
       ...
       var to_date = '<?php echo isset($_REQUEST["to_date"]) ? $_REQUEST["to_date"] : "";?>'; 
        ...
        window.open(
                "<?php echo base_url()?>reports/export_csv?order_no="+order_no+"&user_id="+user_id+"&status_name="+status_name+"&from_date="+from_date+"&to_date="+to_date+"&difficulty_name="+difficulty_name+"&client="+client+"&category="+category+"&po_no="+po_no,
