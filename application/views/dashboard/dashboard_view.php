            ...
            <div class="container-fluid">
                ...
                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS total_orders FROM cad_view')->result_array()[0]['total_orders'];?></span></h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        ?>
                        <a href="<?php echo base_url();?>production_orders?status_name=<?php echo $result['id'];?>">
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup">
                                            <?php echo $this->db->query('SELECT COUNT(id) AS pending_orders FROM cad_view WHERE status = '.$status_id)->result_array()[0]['pending_orders'];?>
                                        </span></h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS allocated_orders FROM cad_view WHERE status = '.$status_id)->result_array()[0]['allocated_orders'];?>
                                        </span></h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS in_process_orders FROM cad_view WHERE status = '.$status_id)->result_array()[0]['in_process_orders'];?></span></h3>
                ...
                <div class="row">
                        ...
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup">
                                            <?php echo $this->db->query('SELECT COUNT(id) AS paused_orders FROM cad_view WHERE status = '.$status_id)->result_array()[0]['paused_orders'];?>
                                        </span></h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS qc_pending_orders FROM cad_view WHERE status = '.$status_id)->result_array()[0]['qc_pending_orders'];?></span></h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS qc_accept_orders FROM cad_view WHERE status = '.$status_id)->result_array()[0]['qc_accept_orders'];?>
                                        </span></h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS completed_orders FROM cad_view WHERE status = '.$status_id)->result_array()[0]['completed_orders'];?>
                                    </span></h3>
                        ...
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup">
                                            <?php echo $this->db->query('SELECT COUNT(id) AS rejected_orders FROM cad_view WHERE status = '.$status_id)->result_array()[0]['rejected_orders'];?>
                                        </span></h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS rejected_orders FROM cad_view WHERE status = (SELECT id FROM status WHERE status_name = "Modification")')->result_array()[0]['rejected_orders'];?></span></h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS rejected_orders FROM cad_view WHERE status = (SELECT id FROM status WHERE status_name = "Repair")')->result_array()[0]['rejected_orders'];?></span></h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS rejected_orders FROM cad_view WHERE status = (SELECT id FROM status WHERE status_name = "STL Requested")')->result_array()[0]['rejected_orders'];?></span></h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS rejected_orders FROM cad_view WHERE status = (SELECT id FROM status WHERE status_name = "STL QC")')->result_array()[0]['rejected_orders'];?></span></h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS rejected_orders FROM cad_view WHERE status = (SELECT id FROM status WHERE status_name = "STL Ready")')->result_array()[0]['rejected_orders'];?></span></h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS rejected_orders FROM cad_view WHERE status = (SELECT id FROM status WHERE status_name = "STL Process")')->result_array()[0]['rejected_orders'];?></span></h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS rejected_orders FROM cad_view WHERE status = (SELECT id FROM status WHERE status_name = "STL Reject")')->result_array()[0]['rejected_orders'];?></span></h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS rejected_orders FROM cad_view WHERE status = (SELECT id FROM status WHERE status_name = "STL Accept")')->result_array()[0]['rejected_orders'];?></span></h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS rejected_orders FROM cad_view WHERE status = (SELECT id FROM status WHERE status_name = "PDW Sent")')->result_array()[0]['rejected_orders'];?></span></h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <a href="<?php echo base_url();?>production_orders?status_name=0">
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                <div class="col-6">
                                    <div class="avatar-lg rounded-circle bg-danger">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <?php 
                                        $today = date('Y-m-d');
                                        $overdue = $this->db->query('SELECT COUNT(id) AS overdue FROM cad_view WHERE status IN (SELECT id FROM status WHERE status_name != "Completed") AND deadline < "'.$today.'"')->result_array()[0]['overdue'];
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS total_users FROM users WHERE user_role = (SELECT id FROM role WHERE role_name = "designer")')->result_array()[0]['total_users'];?></span></h3>
                                        <p class="text-muted mb-1 text-truncate">Total Designers</p>
                                    </div>
                                </div>
                            </div> <!-- end row-->
                        </div> <!-- end widget-rounded-circle-->
                    ...
                    <div class="col-md-6 col-xl-3">
                        <a href="<?php echo base_url();?>users/available">
                        <div class="widget-rounded-circle card-box">
                            <div class="row">
                                <div class="col-6">
                                    <div class="avatar-lg rounded-circle bg-primary">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $this->db->query('SELECT COUNT(id) AS available_designers FROM last_login WHERE user_role = (SELECT id FROM role WHERE role_name = "designer") AND last_login_date = "'.date('Y-m-d').'"')->result_array()[0]['available_designers'];?></span></h3>
...
<script>
    $(document).ready(function(){
        ...
        $("#tickets-table").DataTable({language:{paginate:{previous:"<i class='mdi mdi-chevron-left'>",next:"<i class='mdi mdi-chevron-right'>"}},drawCallback:function(){$(".dataTables_paginate > .pagination").addClass("pagination-rounded")}})
    });
</script>
