                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="<?php echo base_url();?>portal_orders/bulk_media_form_action" method="post" class="dropzone" id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate" enctype="multipart/from-data">
...
$(function() {
    ...
    var myDropzone = new Dropzone(".dropzone", {
        url: "<?php echo base_url();?>portal_orders/bulk_media_form_action",
        paramName: "file",
        maxFilesize: 40,
        maxFiles: 500,
        ...
        success: function (file, response, data) {
         ...
         if(obj.status == 0)
         {
            $('#file-errors').append(obj.image_name+' Not Uploaded<br>');
         }
         // console.log('Success');
         },
