                                            ...
                                            <?php
                                                ...
                                                if(isset($_REQUEST['basic_datepicker']) && $_REQUEST['basic_datepicker'] != '')
                                                {
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        echo date('d F Y', strtotime($_REQUEST['basic_datepicker']));
                                                        ?>
                                                    </div>
                                                    <?php
                                                }
                                                ...
                                                if(isset($_REQUEST['basic_datepicker1']) && $_REQUEST['basic_datepicker1'] != '')
                                                {
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        echo date('d F Y', strtotime($_REQUEST['basic_datepicker1']));
                                                        ?>
                                                    </div>
                                                    <?php
                                                }
...
<!--                                            <button type="button" class="btn btn-success mb-2 mr-1"><i class="mdi mdi-cog"></i></button>-->
                                            ...
                                            <!-- <button class="btn btn-success mb-2" onclick="sync_order()"> Sync Online Order <i class="mdi mdi-plus-circle mr-2"></i></button> -->
                                        </div>
                                    </div><!-- end col-->
                                </div>
                                ...
                                <div class="table-responsive" style="overflow-x:hidden;">
                                    ...
                                    <table class="table table-hover table-bordered m-0 table-centered " id="tickets-table">
                                       ...
                                       if(isset($_REQUEST['basic_datepicker']) && $_REQUEST['basic_datepicker'] != '')
                                        ...
                                        $this->db->where(['moved_to_production' => 0, 'delete_flag' => 0]);
                                        ...
                                        foreach($row as $r)
                                        {
                                            ...
                                            <tr id="order_id_"<?php echo $r['id'];?>>
                                                <td>
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input sub_checks" id="customCheck<?php echo $i;?>" value="<?php echo $r['id'];?>">
                                                        <label class="custom-control-label" for="customCheck<?php echo $i;?>"></label>
                                                    </div>
                                                </td>
                                                <td><input type="hidden" value="<?php echo $r['id'];?>" class="hidden_id"><?php echo $i; ?></td>
                                                <td><?php echo $r['type'] == 'CAD' || $r['type'] == 'CAD-RENDER' ? '<a href="'.base_url().'production_orders/form_view/port/'.$r['order_number'].'">'.$r['order_number'].'</a>' : '<a href="'.base_url().'portal_orders/form_view/view/'.$r['id'].'">'.$r['order_number'].'</a>'; ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                            <button type="button" onclick="file_path(<?php echo $r['id']; ?>);" class="tabledit-edit-button btn btn-success btn-xs active" style="float: none;"><span class="mdi mdi-plus-circle"></span> Add</button>       
                                                    <?php
                                                        }
                                                    ?>
                                                </td>
...
<!--                                                <td>-->
<!--                                                    <a href="javascript:move_to_production(--><?php //echo $r['id']; ?><!--);" class="action-icon"> <i class="mdi mdi-arrow-right-bold-circle"></i></a>-->
<!---->
<!--                                                </td>-->
                                            </tr>
                                            <?php
...
<div class="modal fade" id="filter-modal" tabindex="-1" role="dialog" aria-hidden="true">
 ...
 -->
                    <div class="form-group">
                        <label>From</label>
                        <input type="text" id="basic-datepicker" name="basic_datepicker" class="form-control" placeholder="From Date">
                    </div>

                    <div class="form-group">
                        <label>To</label>
                        <input type="text" id="basic-datepicker1" name="basic_datepicker1" class="form-control" placeholder="To Date">
                    </div>
...
<script>
    ...
    {
        $.ajax({
            url: '<?php echo base_url();?>portal_orders/sync_order',
            type: 'POST',
            dataType:'json',
            async:false,
            success: function(result){
                ...
                $('.flash_msg').html('<div class="alert alert-success alert-dismissible bg-success text-white border-0 fade show" role="alert">'+
                                '<button type="button" class="close" data-dismiss="alert" aria-label="Close">'+
                                    '<span aria-hidden="true">×</span>'+'</button>'+result.message+'</div>');
                setTimeout(function() {
                    location.reload();
