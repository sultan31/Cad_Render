                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-2">
                                    <div class="col-sm-4">
                                        <a href="javascript:void(0);" onclick="open_modal();" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle mr-2"></i> Add Status</a>
                                    </div>
                                    <div class="col-sm-8">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h4 class="modal-title" id="myCenterModalLabel">Add New Status</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body p-4">
                <form action="<?php echo base_url();?>status/form_action" method="post" class="parsley-examples" id="myform">
                    <input type="hidden" name="status_id" id="status_id" value="">
                    <div class="form-group">
                        <label for="name">Status Name</label>
                        <input data-parsley-pattern="/^[a-zA-Z ]*$/" type="text" class="form-control" id="status_name" name="status_name" placeholder="Enter status name" required>
                    </div>
...
<script>
    ...
    function edit_record(id) {
        $.ajax({
            url: '<?php echo base_url();?>status/fetch_record?id='+id,
            type: 'GET',
            dataType:'json',
            success: function(result){

                $("#status_id").val(result.data.id);
                $("#status_name").val(result.data.status_name);
    ...
    $(".sa-warning").click(function()
    {
        ...
        Swal.fire({title:"Are you sure?",text:"You won't be able to revert this!",type:"warning",showCancelButton:!0,confirmButtonColor:"#3085d6",cancelButtonColor:"#d33",confirmButtonText:"Yes, delete it!"}).then(function(t)
        {
            ...
            {
                $.ajax({
                    url: '<?php echo base_url();?>status/remove',
                    type: 'POST',
                    data:{'id':id},
                    dataType:'json',
                    success: function(result){
