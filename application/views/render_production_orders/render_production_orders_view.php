                    ...
                    <div class="col-12">
                        ...
                        <div class="card-box">
                            ...
                            <form action="<?php echo base_url();?>render_production_orders/remove" id="list_form" method="post">
                                ...
                                <input type="hidden" name="filtered_department_id" id="filtered_department_id" value="<?php echo isset($_REQUEST['department_id']) && !empty($_REQUEST['department_id']) ? $_REQUEST['department_id'] : '';?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form action="<?php echo base_url();?>render_production_orders/assign" method="post" class="parsley-examples edit_form" id="general_form">
                    ...
                    <input type="hidden" id="custom_department_id" name="custom_department_id" value="<?php echo isset($_REQUEST['department_id']) && !empty($_REQUEST['department_id']) ? $_REQUEST['department_id'] : '';?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form action="<?php echo base_url();?>render_production_orders/qc_reject" method="post" class="parsley-examples" id="change_status_form">
                    ...
                    <input type="hidden" id="rej_department_id" name="rej_department_id" value="<?php echo isset($_REQUEST['department_id']) && !empty($_REQUEST['department_id']) ? $_REQUEST['department_id'] : '';?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form action="<?php echo base_url();?>render_production_orders/complete" method="post" class="parsley-examples" id="complete_form">
                    ...
                    <input type="hidden" id="complete_department_id" name="complete_department_id" value="<?php echo isset($_REQUEST['department_id']) && !empty($_REQUEST['department_id']) ? $_REQUEST['department_id'] : '';?>">
                    ...
                    <div class="form-group">
                        <label for="img_file_path">IMG File</label>
                        <input type="text" name="img_file_path" id="img_file_path" class="form-control" required placeholder="Enter Path"/>
                    </div>
...
<div class="modal fade" id="send_to_all_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h4 class="modal-title" id="modal_heading">Send Order</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body p-4">
                <form action="<?php echo base_url();?>render_production_orders/send_to_dept" method="post" class="parsley-examples" id="send_form">
                    <input type="hidden" id="which_order_id" name="which_order_id" value="">
                    
                    <div class="form-group">
                        <label for="which_dept">Move To Department</label>
                        <select data-parsley-errors-container="#which_dept-errors" class="form-control" name="which_dept" id="which_dept" data-toggle="select2" required>
                            <option value="">Select</option>
                                <?php
                                $department = $this->db->query('SELECT * FROM `department` WHERE `dept_name` != "Customer Service"');
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form action="<?php echo base_url();?>render_production_orders/go_back" method="post" class="parsley-examples">
                    ...
                    <input type="hidden" name="gobk_department_id" id="gobk_department_id" value="<?php echo isset($_REQUEST['department_id']) && !empty($_REQUEST['department_id']) ? $_REQUEST['department_id'] : '';?>">
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form action="<?php echo base_url();?>render_production_orders/send_to_manager" method="post" class="parsley-examples">
                    ...
                    <input type="hidden" name="send_department_id" id="send_department_id" value="<?php echo isset($_REQUEST['department_id']) && !empty($_REQUEST['department_id']) ? $_REQUEST['department_id'] : '';?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form action="<?php echo base_url();?>render_production_orders/pause_timer" method="post" class="parsley-examples">
                    ...
                    <input type="hidden" id="pause_department_id" name="pause_department_id" value="<?php echo isset($_REQUEST['department_id']) && !empty($_REQUEST['department_id']) ? $_REQUEST['department_id'] : '';?>">
                    <div class="form-group">
...
<script>
    ...
    // } );
     ...
     $('#tickets-table').DataTable({
                ...
                //stateSave: true,
                ajax: {
                    url: "<?php echo base_url(); ?>render_production_orders/fetch_orders",
                    type: "POST",
                    data : {
                        ...
                        "f_priority" : "<?php echo isset($_REQUEST['f_priority']) && !empty($_REQUEST['f_priority']) ? $_REQUEST['f_priority'] : ''?>",
                        "department_id" : "<?php echo isset($_REQUEST['department_id']) && !empty($_REQUEST['department_id']) ? $_REQUEST['department_id'] : ''?>",
               ...
               //order: [[0, "asc"]],
                scrollX: true,
                scroller: true,
                columns: [{data: "check"}, {data: "order_number"}, {data: "client_design_no"}, {data: "po_no"}, {data: "priority"}, {data: "category"}, {data: "order_date"}, {data: "dept_name"}, {data: "status"}, {data: "file_path"}, {data: "difficulty_name"}, {data: "designer"}, {data: "action"}]
...
<script>
    ...
    function complete(order_id, assigned_to, department_id, show_depts)
    {
        $("#action_buttons_modal").modal("toggle");
        ...
        $.ajax({
                ...
                success: function(result){
                    ...
                    $('#video_file_path').val(json.video_file_path);
                    $('#img_file_path').val(json.file_path);
                }
            });
...
<script type="text/javascript">
    ...
    function action_buttons(order_id)
    {
        ...
        $.ajax({
            url: '<?php echo base_url();?>render_production_orders/action_buttons',
            type: 'POST',
            data:{'order_id':order_id},
            dataType:'json',
            async:false,            
    ...
    function send_to(department_id, order_id)
    {
        $("#action_buttons_modal").modal("toggle");
        $("#send_to_all_modal").modal("toggle");
        $("#which_order_id").val(order_id);      
    }
  </script>
