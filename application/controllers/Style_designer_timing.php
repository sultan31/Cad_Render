...
class Style_designer_timing extends CI_Controller
{
    ...
    {
        $this->load->view('reports/style_designer_timing_view');
    }
    ...
    public function export_csv()
    {
        ...
        if($res->num_rows() > 0)
        {
            ...
            foreach($result as $r)
            {
                ...
                {
                    $actual_time = date('H:i', strtotime($actual_time_query->result_array()[0]['actual_time']));
                }
